# PROGRAM Queues as Linked Lists:
...
def CreateEmptyQueue():
    global QueueHead
    global QueueTail
    QueueHead = QueueTail = None
# END CreateEmptyQueue.
...
def QueueIsEmpty():
    global QueueHead
    global QueueTail
    return QueueHead == QueueTail == None
# END QueueIsEmpty.
